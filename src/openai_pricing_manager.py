"""
openai_pricing_manager.py - Gestore tariffe API OpenAI per modelli LLM.

Questo modulo carica e gestisce le tariffe di utilizzo dell'API OpenAI da file CSV,
fornendo metodi per calcolare costi basati su token utilizzati. Supporta:
- Prezzi differenziati per input/output/cached tokens
- Conversione USD/EUR
- Gestione categorie di pricing (Text tokens - Standard, etc.)
- Validazione prezzi e gestione errori

Input: File CSV openai_pricing.csv
Output: Oggetto Pricing per calcoli costi
Dipendenze: decimal
"""
